...
use crate::core::messages::{self, ButtplugClientOutMessage, ButtplugClientInMessage, ButtplugInMessage, ButtplugOutMessage};
use async_std::{
    prelude::StreamExt,
...
impl ButtplugJSONServerWrapper {
    ...
    fn convert_incoming(msg: String) -> ButtplugInMessage {
        //msg.into()
        ButtplugInMessage::Ping(messages::Ping::default())
    }

    fn convert_outgoing(msg: ButtplugOutMessage) -> String {
        //msg.try_into().unwrap()
        "test".to_string()
    }
}
