...
fn check_message_support(message_type: &ButtplugDeviceMessageType, message_attributes: &MessageAttributesMap) -> Result<(), ButtplugError> {
...
pub trait ButtplugProtocolProperties {
  ...
  fn supports_message(&self, message: &ButtplugDeviceCommandMessageUnion) -> Result<(), ButtplugError> {
    // TODO This should be generated by a macro, as should the types enum.
    match message {
      ButtplugDeviceCommandMessageUnion::BatteryLevelCmd(_) => check_message_support(&ButtplugDeviceMessageType::BatteryLevelCmd, &self.message_attributes()),
      ButtplugDeviceCommandMessageUnion::FleshlightLaunchFW12Cmd(_) => check_message_support(&ButtplugDeviceMessageType::FleshlightLaunchFW12Cmd, &self.message_attributes()),
      ButtplugDeviceCommandMessageUnion::KiirooCmd(_) => check_message_support(&ButtplugDeviceMessageType::KiirooCmd, &self.message_attributes()),
      ButtplugDeviceCommandMessageUnion::LinearCmd(_) => check_message_support(&ButtplugDeviceMessageType::LinearCmd, &self.message_attributes()),
      ButtplugDeviceCommandMessageUnion::RawReadCmd(_) => check_message_support(&ButtplugDeviceMessageType::RawReadCmd, &self.message_attributes()),
      ButtplugDeviceCommandMessageUnion::RawSubscribeCmd(_) => check_message_support(&ButtplugDeviceMessageType::RawSubscribeCmd, &self.message_attributes()),
      ButtplugDeviceCommandMessageUnion::RawUnsubscribeCmd(_) => check_message_support(&ButtplugDeviceMessageType::RawUnsubscribeCmd, &self.message_attributes()),
      ButtplugDeviceCommandMessageUnion::RawWriteCmd(_) => check_message_support(&ButtplugDeviceMessageType::RawWriteCmd, &self.message_attributes()),
      ButtplugDeviceCommandMessageUnion::RotateCmd(_) => check_message_support(&ButtplugDeviceMessageType::RotateCmd, &self.message_attributes()),
      ButtplugDeviceCommandMessageUnion::RSSILevelCmd(_) => check_message_support(&ButtplugDeviceMessageType::RSSILevelCmd, &self.message_attributes()),
      // We translate SingleMotorVibrateCmd into Vibrate, so this one is special.
      ButtplugDeviceCommandMessageUnion::SingleMotorVibrateCmd(_) => check_message_support(&ButtplugDeviceMessageType::VibrateCmd, &self.message_attributes()),
      ButtplugDeviceCommandMessageUnion::StopDeviceCmd(_) => check_message_support(&ButtplugDeviceMessageType::StopDeviceCmd, &self.message_attributes()),
      ButtplugDeviceCommandMessageUnion::VibrateCmd(_) => check_message_support(&ButtplugDeviceMessageType::VibrateCmd, &self.message_attributes()),
      ButtplugDeviceCommandMessageUnion::VorzeA10CycloneCmd(_) => check_message_support(&ButtplugDeviceMessageType::VorzeA10CycloneCmd, &self.message_attributes()),
    }
  }
}
