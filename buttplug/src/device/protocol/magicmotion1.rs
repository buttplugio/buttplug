...
pub struct MagicMotion1ProtocolCreator {
    config: DeviceProtocolConfiguration,
}

impl MagicMotion1ProtocolCreator {
...
#[async_trait]
impl ButtplugProtocolCreator for MagicMotion1ProtocolCreator {
    async fn try_create_protocol(
        ...
        Ok(Box::new(MagicMotion1Protocol::new(name, attrs)))
    }
}

#[derive(Clone)]
pub struct MagicMotion1Protocol {
    name: String,
...
#[async_trait]
impl ButtplugProtocol for MagicMotion1Protocol {
    fn name(&self) -> &str {
        &self.name
    }
    ...
    async fn parse_message(
        ...
        match message {
            ...
            _ => Err(ButtplugError::ButtplugDeviceError(
                ButtplugDeviceError::new("MagicMotion1Protocol does not accept this message type."),
            )),
        }
    }
}
...
impl MagicMotion1Protocol {
    ...
    async fn handle_vibrate_cmd(
        ...
        let msg = DeviceWriteCmd::new(Endpoint::Tx, vec![0x0b, 0xff, 0x04, 0x0a, 0x32, 0x32, 0x00, 0x04, 0x08, self.vibrations[0], 0x64, 0x00], false);
