...
pub struct AnerosProtocolCreator {
    config: DeviceProtocolConfiguration,
}

impl AnerosProtocolCreator {
...
#[async_trait]
impl ButtplugProtocolCreator for AnerosProtocolCreator {
    async fn try_create_protocol(
        ...
        Ok(Box::new(AnerosProtocol::new(name, attrs)))
    }
}
...
#[async_trait]
impl ButtplugProtocol for AnerosProtocol {
    fn name(&self) -> &str {
        &self.name
    }
