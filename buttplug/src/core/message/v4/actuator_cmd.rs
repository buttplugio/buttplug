...
use crate::core::{errors::{ButtplugDeviceError, ButtplugError}, message::{
  ActuatorType, ButtplugDeviceMessage, ButtplugMessage, ButtplugMessageError,
...
impl ActuatorCommand {
  ...
  pub fn from_actuator_type(actuator_type: ActuatorType, value: u32) -> Result<Self, ButtplugError> {
    match actuator_type {
      ...
      x => Err(ButtplugError::ButtplugDeviceError(ButtplugDeviceError::ActuatorNotSupported(x)))
    }
  }
}
