...
use buttplug_server::message::{
  ButtplugClientMessageV1, ButtplugServerMessageV1, DeviceListV1, DeviceMessageInfoV1,
};
use dashmap::DashMap;
  ...
  ConnectorType: ButtplugConnector<ButtplugClientMessageV1, ButtplugServerMessageV1> + 'static,
{
  ...
  from_connector_receiver: mpsc::Receiver<ButtplugServerMessageV1>,
  ...
  ConnectorType: ButtplugConnector<ButtplugClientMessageV1, ButtplugServerMessageV1> + 'static,
{
  ...
  fn create_client_device(&mut self, info: &DeviceMessageInfoV1) -> Arc<ButtplugClientDevice> {
    debug!(
  ...
  async fn parse_connector_message(&mut self, msg: ButtplugServerMessageV1) {
    ...
    info!("{:?}", msg);
    match msg {
      ButtplugServerMessageV1::DeviceAdded(dev) => {
