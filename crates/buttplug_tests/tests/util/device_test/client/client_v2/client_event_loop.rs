  ...
  ConnectorType: ButtplugConnector<ButtplugClientMessageV2, ButtplugServerMessageV2> + 'static,
{
  ...
  from_connector_receiver: mpsc::Receiver<ButtplugServerMessageV2>,
  ...
  ConnectorType: ButtplugConnector<ButtplugClientMessageV2, ButtplugServerMessageV2> + 'static,
{
  ...
  fn create_client_device(&mut self, info: &DeviceMessageInfoV2) -> Arc<ButtplugClientDevice> {
    debug!(
  ...
  async fn parse_connector_message(&mut self, msg: ButtplugServerMessageV2) {
    ...
    info!("{:?}", msg);
    match msg {
      ButtplugServerMessageV2::DeviceAdded(dev) => {
