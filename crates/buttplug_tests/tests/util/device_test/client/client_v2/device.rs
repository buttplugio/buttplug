...
use buttplug_server::message::{
  BatteryLevelCmdV2, ButtplugClientMessageV2, ButtplugDeviceMessageNameV2, ButtplugServerMessageV2,
  ClientDeviceMessageAttributesV2, DeviceMessageInfoV2, LinearCmdV1, RotateCmdV1,
