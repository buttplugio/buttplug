...
impl WebsocketServerDeviceCommunicationManager {
  fn new(
    ...
    async_manager::spawn(
        ...
        loop {
          select! {
            listener_result = listener.accept() => {
              ...
              }, info_span!("WebsocketServerDeviceCommunicationManager::connection_loop").or_current());
            },
      ...
      info_span!("WebsocketServerDeviceCommunicationManager::server_loop").or_current(),
    );
    Self {
