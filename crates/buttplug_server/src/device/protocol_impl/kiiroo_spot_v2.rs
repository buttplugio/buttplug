...
generic_protocol_setup!(KiirooSpotV2, "kiiroo-spot-v2");

#[derive(Default)]
pub struct KiirooSpotV2 {}

impl ProtocolHandler for KiirooSpotV2 {
  fn handle_output_vibrate_cmd(
    ...
    Ok(vec![
      HardwareWriteCmd::new(
        &[feature_id],
        Endpoint::Tx,
        vec![0x01, speed as u8, speed as u8, 0x03, 0xe8, 0xff],
        true,
      )
      .into(),
    ])
