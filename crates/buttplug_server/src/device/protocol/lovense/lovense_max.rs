...
use crate::device::{
    ...
    protocol::{lovense::{form_lovense_command, form_vibrate_command}, ProtocolHandler, ProtocolKeepaliveStrategy},
};
...
#[derive(Default)]
pub struct LovenseMax {}

impl ProtocolHandler for LovenseMax {
  ...
  fn handle_output_constrict_cmd(
    ...
    form_lovense_command(feature_id, &format!("Air:Level:{level};"))
  }
