...
impl MetaXSire {
  ...
  fn form_command(&self, feature_index: u32, speed: u32) -> Result<Vec<HardwareCommand>, ButtplugDeviceError> {
    self.commands[feature_index as usize].1.store(speed as u8, Ordering::Relaxed);
