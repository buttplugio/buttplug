...
async fn set_rotate_with_direction_and_wait(
  dev: &Arc<ButtplugClientDevice>,
  feature: &ClientDeviceFeature,
  output_type: &OutputType,
  level: f64,
  ...
  feature
    .send_command(&ClientDeviceOutputCommand::RotateWithDirectionFloat(
      level, clockwise,
    ))
    .await
    .unwrap();
...
async fn set_position_with_duration_and_wait(
  dev: &Arc<ButtplugClientDevice>,
  feature: &ClientDeviceFeature,
  output_type: &OutputType,
  level: f64,
