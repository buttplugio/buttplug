...
- [[file:generic.md#generic-device-messages][Generic Device Messages]]
  - [[file:generic.md#stop-device-cmd][StopDeviceCmd]]
  - [[file:generic.md#stop-all-devices][StopAllDevices]]
...
- [[file:specific.md#specific-device-messages][Specific Device Messages]]
  - [[file:specific.md#kiiroo-cmd][KiirooCmd]]
...
- /Command/ (Array of unsigned int): Command to send, array of ints
...
run whatever event may be related. More information on Fleshlight
Launch commands can be found in STPIHKAL.
...
- /Command/ (string): String command for Lovense toys. Must be a valid
  ...
  more info. Library implementations should check this for validity.
